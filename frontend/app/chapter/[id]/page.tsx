          ...
          <motion.div initial={{scale:0.9,opacity:0}} animate={{scale:1,opacity:1}} exit={{scale:0.9,opacity:0}}
            ...
            <div style={{display:"flex",gap:8,alignItems:"center",marginBottom:16}}>
              ...
              <input value={val} onChange={e=>{setVal(e.target.value);setFeedback("")}} type="number" inputMode="numeric" placeholder="189" autoFocus
                onKeyDown={e=>{if(e.key==="Enter"&&val){setFeedback("→ Navigating to page "+val+"...");setTimeout(onClose,800)}}}
            ...
            <button disabled={!val} onClick={()=>{setFeedback("→ Navigating to page "+val+"...");setTimeout(onClose,800)}}
