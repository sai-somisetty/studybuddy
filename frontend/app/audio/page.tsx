  ...
  if (activeChapter) {
    ...
    return (
      <div style={{ minHeight: "100vh", background: C.navy, fontFamily: "'DM Sans', sans-serif", display: "flex", flexDirection: "column" }}>
        {/* Header */}
        <div style={{ padding: "max(env(safe-area-inset-top, 20px), 20px) 20px 16px", maxWidth: 720, margin: "0 auto", width: "100%" }}>
        ...
        {/* Album art area */}
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 40px", maxWidth: 720, margin: "0 auto", width: "100%" }}>
          {/* Big icon */}
          <motion.div
        ...
        {/* Mini playlist */}
        <div style={{ maxWidth: 720, margin: "0 auto", width: "100%", padding: "16px 20px", paddingBottom: "max(20px, env(safe-area-inset-bottom, 20px))" }}>
