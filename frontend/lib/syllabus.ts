    ...
    cma: {
      foundation: {
        ...
        subjects: [
          ...
          { id:"cma_f_acc",   code:"Paper 2", title:"Fundamentals of Financial & Cost Accounting",   icon:"📊", color:"#3B6D11", bg:"#DCFCE7", chapters:4 },
          { id:"cma_f_maths", code:"Paper 3", title:"Fundamentals of Business Mathematics & Statistics", icon:"🔢", color:"#854F0B", bg:"#FEF9C3", chapters:8 },
          { id:"cma_f_eco",   code:"Paper 4", title:"Fundamentals of Business Economics & Management",   icon:"📈", color:"#0F6E56", bg:"#CCFBF1", chapters:5 },
        ],
      },
      inter: {
        hasGroups: true,
