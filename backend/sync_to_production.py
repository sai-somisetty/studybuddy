    ...
    for book_page, page_concepts in pages.items():
        ...
        for c in page_concepts:
            mama_lines.append({
                ...
                "tenglish": c.get("tenglish", ""),
                "tenglish_variation_2": c.get("tenglish_variation_2", ""),
                "tenglish_variation_3": c.get("tenglish_variation_3", ""),
                "kitty_question": c.get("kitty_question", ""),
                "mama_kitty_answer": c.get("mama_kitty_answer", ""),
                "check_question": c.get("check_question", ""),
                "check_options": c.get("check_options", []),
                "check_answer": c.get("check_answer", 0),
                "check_explanation": c.get("check_explanation", ""),
